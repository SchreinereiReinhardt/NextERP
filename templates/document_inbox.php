...
<div class="erp-project-center-metrics erp-beleg-metrics<?=$blockClass('kpis')?>" data-beleg-block="kpis"><div><span>Neu</span><strong><?php p($_['counts']['new']??0);?></strong></div><div><span>In Prüfung</span><strong><?php p($_['counts']['review']??0);?></strong></div><div><span>Zugeordnet</span><strong><?php p($_['counts']['assigned']??0);?></strong></div><div><span>Fehler</span><strong><?php p($_['counts']['error']??0);?></strong></div></div>
