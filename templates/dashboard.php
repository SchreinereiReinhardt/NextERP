...
$roleLabel=$roleNames[$role]??'NextERP';
?>
...
<div class="erp-head erp-dashboard-head"><div><span class="erp-record-kicker">NextERP · <?=p($roleLabel)?></span><h1>Guten Tag, <?=p($displayName)?></h1><p class="erp-sub"><?=p(date('d.m.Y'))?> · Was heute im Betrieb wichtig ist</p></div><div class="erp-actions">
