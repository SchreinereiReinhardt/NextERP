...
<h1>Betrio Mobile</h1><p class="ma-lead">Mobile-Zugang für Monteure, Smartphone und Tablet verwalten.</p>
<div class="ma-grid">
...
<section class="ma-card"><h2>App-Stores</h2><div class="ma-soon"><b>Google Play</b><a href="https://play.google.com/store/apps/details?id=de.nexterp.mobile" target="_blank" rel="noopener noreferrer">Jetzt bei Google Play</a></div><div class="ma-soon"><b>Apple App Store</b><span class="ma-muted">Demnächst verfügbar</span></div><p class="ma-muted">Betrio Mobile ist für Android bei Google Play verfügbar. Die iOS-Version folgt später.</p></section>
...
<section class="ma-card"><h2>Monteur vorbereiten</h2><ol class="ma-list"><li>Eigenes Nextcloud-Benutzerkonto anlegen.</li><li>Passende Mitarbeiter-/Monteur-Gruppe zuweisen.</li><li>Der Mitarbeiter meldet sich einmalig mit seinem neuen Konto in Nextcloud an.</li><li>Danach in Betrio unter <b>Benutzer & Rechte</b> die Betrio-Rechte kontrollieren.</li><li>Benötigte Projekte freigeben.</li><li>Mobile-Link oder QR-Code an den Mitarbeiter geben.</li></ol><a class="ma-btn alt" href="<?php p($url->linkToRoute('reinhardterp.business.documentation')); ?>#users">Anleitung öffnen</a></section>
...
<section class="ma-card wide"><h2>Systemstatus</h2><p><b>Betrio:</b> Version <?php p($_['appVersion']); ?> &nbsp; · &nbsp; <b>Mobile PWA:</b> aktiv &nbsp; · &nbsp; <b>Offline-Basis:</b> aktiv &nbsp; · &nbsp; <b>Zeit-/Material-Sync:</b> aktiv</p><p class="ma-muted">Weitere technische Prüfungen finden Sie unter Verwaltung → Systemprüfung.</p></section>
</div></main></div>
<script>
(function(){
